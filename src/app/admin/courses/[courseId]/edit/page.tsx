...
const EditRoute = async ({ params }: EditRouteProps) => {
    const data  = await adminGetCourse(params.courseId);
  return (
    <div>
        <h1 className='text-2xl font-bold mb-8 flex items-center gap-2'>
            Edit Course: {" "}
            <span className='text-primary line-clamp-2 hover:underline'>{data.title}</span>
        </h1>
            ...
            <TabsContent value="course-structure" className="mt-6">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Define the structure of your course including sections and lessons.
                        </CardDescription>
                        <CardContent>
